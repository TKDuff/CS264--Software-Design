...
public abstract class Shape
{
    ...
    //Line styling, default line and fill styles
...
public class Rectangle : Shape
{
    ...
    public override string svgLine() => "<rect x=\"" + xPos + "\" y=\"" + yPos+ "\" width=\"" + width + "\" height=\"" + height + "\" style=\"stroke:" + stroke + ";fill:" + fill + ";stroke-width:" + strokeWidth +"\" />";
...
public class Circle : Shape
{
    ...
    public override string svgLine() => "<circle cx=\"" + xPos + "\" cy=\"" + yPos+ "\" r=\"" + rx + "\" style=\"stroke:" + stroke + ";fill:" + fill + ";stroke-width:" + strokeWidth +"\" />";
...
public class Ellipse : Shape
{
    ...
    public override string svgLine() => "<ellipse cx=\"" + xPos + "\" cy=\"" + yPos+ "\" rx=\"" + rx + "\" ry=\"" + ry + "\" style=\"stroke:" + stroke + ";fill:" + fill + ";stroke-width:" + strokeWidth +"\" />";
...
public class Line : Shape
{
    ...
    public override string svgLine() => "<line x1=\"" + x1 + "\" x2=\"" + x2 +  "\" y1=\"" + y1 + "\" y2=\"" + y2 + "\" style=\"stroke:" + stroke + ";fill:" + fill + ";stroke-width:" + strokeWidth +"\" />";
...
public class Polygon : Shape
{
    ...
    public override string svgLine() => "<polygon points=\"" + points + "\" style=\"stroke:" + stroke + ";fill:" + fill + ";stroke-width:" + strokeWidth +"\" />";
...
public class Polyline : Shape
{
    ...
    public override string svgLine() => "<polyline points=\"" + points + "\" style=\"stroke:" + stroke + ";fill:" + fill + ";stroke-width:" + strokeWidth +"\" />";
