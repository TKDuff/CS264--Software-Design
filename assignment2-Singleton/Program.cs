...
namespace ShapeZIndex
{
    class Program
    {
        ...
        public static void createShape(Canvas c) {
            ...
            {
                case "R":
                c.Shapes.Add(new Rectangle());
                break;
                case "C":
                c.Shapes.Add(new Circle());
                break;
                case "E":
                c.Shapes.Add(new Ellipse());
                break;
                case "L":
                c.Shapes.Add(new Line());
                break;
                case "PG":
                c.Shapes.Add(new Polygon());
                break;
                case "PL":
                c.Shapes.Add(new Polyline());
                break;
            }
        }
